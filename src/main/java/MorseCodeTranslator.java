...
public class MorseCodeTranslator {
    ...
    private String info = "Morse Translator by codecat-19";
    ...
    public MorseCodeTranslator() {
       ...
       //System.out.println(morseToEnglishLib.toString());
        ...
        englishTextArea.setText("Abstract");
        ...
        frame.setTitle("Morse Translator by codecat-19");
    ...
    Stream.of(englishWord.split("[ \n]"))
            .forEach(s -> {
                ...
                for (char c : s.toCharArray()) {
                    String v = englishToMorseLib.containsKey(String.valueOf(c).toUpperCase()) ? morseToEnglishLib.get(String.valueOf(c).toUpperCase()) : " [error] ";
